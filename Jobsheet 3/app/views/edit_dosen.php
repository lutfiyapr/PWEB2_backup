...
<a href="tampil_dosen.php" class="btn btn-warning" onclick = "return confirm('Data tidak akan tersimpan! tetap lanjut?');">Kembali</a>
  <br>
  <br>
...
<div class="alert alert-warning d-flex align-items-center col-sm-4" role="alert">
  <div>
    ...
    <form method="post" action="proses_dosen.php?aksi=update_dosen">
    <?php
	...
	<table>
        <div class="aa">
          <tr>
          <td class="col-sm-2 col-form-label">Nidn</td>
          <div class="col-sm-10">
          <input type="hidden" name="id" value="<?php echo $d['nidn']?>">
          <td><input type="text" name="nidn" id="" value="<?php echo $d['nidn']?>" class="form-control"></td>
          </div>
          </tr>
        </div>
        <div class="aa">
