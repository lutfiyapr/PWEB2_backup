...
<div class="table-responsive large">
    <table border="1" class="table table-striped table-sm">
        ...
        <tr>
            ...
            <td>
                <a href="edit_mhs.php?npm=<?php echo $x['npm'];?>&aksi=edit" class="btn btn-warning" onclick = "return confirm('Yakin Untuk mengedit data?');">Edit</a>
                <a href="proses_mhs.php?npm=<?php echo $x['npm'];?>&aksi=hapus"class="btn btn-danger" onclick = "return confirm('Yakin menghapus data?');"> Hapus</a>
            </td>
        </tr>
        <?php
        }
